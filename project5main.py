...
l_track_speeds = ["q-learner-L-track-10000.csv-lap-speeds.csv", "sarsa-learner-L-track-10000.csv-lap-speeds.csv"]
o_track_speeds = ["q-learner-O-track-10000.csv-lap-speeds.csv", "sarsa-learner-O-track-10000.csv-lap-speeds.csv"]
r_track_speeds = ["q-learner-R-track-10000.csv-lap-speeds.csv", "sarsa-learner-R-track-10000.csv-lap-speeds.csv"]

all_results = [l_track_speeds, o_track_speeds, r_track_speeds]
